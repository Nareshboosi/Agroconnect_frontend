...
const CropList = () => {
  ...
  const handleEdit = (id) => navigate(`/admin/crops/edit/${id}`);
  const handleView = (id) => navigate(`/admin/crops/view/${id}`);
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <input
        ...
        value={search}
        onChange={(e) => setSearch(e.target.value)}
        className="mb-4 w-full sm:w-1/2 md:w-1/3 px-4 py-2 border rounded-lg shadow-sm
